<?php /*a:1:{s:69:"C:\xampp\htdocs\ims.gzkxly.com\application\area\view\index\login.html";i:1562661474;}*/ ?>
<!doctype html>
...
<div class="layui-header" style="background-color: #24262F;font-size: 14px;">
    <div class="layui-container">
        <a style="position: absolute;left: 0;top: 5px;">
            <img src="/static/images/banner.png" alt="layui"><span style="color: white"> | 区域代理</span>
        </a>
        <ul class="layui-nav" style="position:absolute;top: 0;right: 0;background: none;">
            ...
            <li class="layui-nav-item  layui-this"><a href="https://ims.gzkxly.com/area/index/login">区域代理登录</a></li>
...
<script>
    ...
    new WxLogin({
        ...
        scope: "snsapi_login",
        redirect_uri: "https://ims.gzkxly.com/area/index/login",
